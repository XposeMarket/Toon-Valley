...
try{
  ...
  if(report.afterChase.dragonflyPairChases<=report.chaseBefore.dragonflyPairChases||report.afterChase.chaseCorrections<=report.chaseBefore.chaseCorrections)throw new Error(`Airborne dragonflies did not perform paired chase behavior ${JSON.stringify({before:report.chaseBefore,after:report.afterChase})}`);
