...
try{
 ...
 await page.waitForFunction(()=>window.ToonValleyCentralPlaza&&window.ToonValleyPublicInteriors&&window.ToonValleyTheater&&window.ToonValleyOwnedHome&&window.ToonValleyWorldPolish&&window.ToonValleyBluebellLake&&window.ToonValleyTransit&&window.ToonValleyLivingInteriors&&window.ToonValleyInteractionExperience&&window.ToonValleyServices,null,{timeout:30000});
 const state=await page.evaluate(()=>{
  const TV=window.ToonValley,LI=window.ToonValleyLivingInteriors,T=window.ToonValleyTransit,X=window.ToonValleyInteractionExperience;
