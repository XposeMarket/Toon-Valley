...
try{
 ...
 await page.waitForFunction(()=>window.ToonValleyCentralPlaza&&window.ToonValleyPublicInteriors&&window.ToonValleyTheater&&window.ToonValleyOwnedHome&&window.ToonValleyWorldPolish&&window.ToonValleyBluebellLake&&window.ToonValleyInteractionFix&&window.ToonValleyTransit&&window.ToonValleyCommunityGarden&&window.ToonValleyLivingInteriors&&window.ToonValleyInteractionExperience&&window.ToonValleySwingExitFix&&window.ToonValleyNPCBuildingLife&&window.ToonValleyMobilePolish&&window.ToonValleyServices,null,{timeout:60000});
 await page.waitForFunction(()=>!document.getElementById('boot-status'),null,{timeout:15000});
 const s=await page.evaluate(()=>({deployedCommit:document.querySelector('meta[name="toon-valley-commit"]')?.content||null,plaza:window.ToonValleyCentralPlaza.picnicTables,publicInteriors:window.ToonValleyPublicInteriors.counts,theater:window.ToonValleyTheater.counts,ownedHome:window.ToonValleyOwnedHome.counts,world:window.ToonValleyWorldPolish,lake:window.ToonValleyBluebellLake.counts,transit:window.ToonValleyTransit.counts,living:window.ToonValleyLivingInteriors.counts,interaction:window.ToonValleyInteractionExperience,swingFix:window.ToonValleySwingExitFix,npcLife:window.ToonValleyNPCBuildingLife.counts,mobile:window.ToonValleyMobilePolish,annex:window.ToonValleyServices.gardenAnnex,interactables:window.ToonValley.interactables.length}));
 ...
 if(!s.swingFix?.active||s.swingFix.exitDistance<1.7)throw new Error(`Production swing dismount safety missing ${JSON.stringify(s.swingFix)}`);
 if(s.npcLife.destinations<10||s.npcLife.npcs<10)throw new Error(`Production NPC building life missing ${JSON.stringify(s.npcLife)}`);
